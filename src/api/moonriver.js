...
export function getLatestBlockNumber(params) {
    return request({
        url: '/moonriver-analysis/getLatestBlockNumber',
        method: 'get',
        params
    })
}
...
export function getCurrentRoundInfo(params) {
    return request({
        url: '/moonriver-analysis/getCurrentRoundInfo',
        method: 'get',
        params
    })
}
...
export function getMaxNominatorsPerCollator(params) {
    return request({
        url: '/moonriver-analysis/getMaxNominatorsPerCollator',
        method: 'get',
        params
    })
}
...
export function getRealtimeCollatorCandidatePool(params) {
    return request({
        url: '/moonriver-analysis/getRealtimeCollatorCandidatePool',
        method: 'get',
        params
    })
}
...
export function getSelectedCollators4CurrentRound(params) {
    return request({
        url: '/moonriver-analysis/getSelectedCollators4CurrentRound',
        method: 'get',
        params
    })
}
...
export function getRealtimeCollatorState(data) {
    return request({
        url: '/moonriver-analysis/getRealtimeCollatorState',
        method: 'post',
        data
    })
}
...
export function getScheduledExitQueue(params) {
    return request({
        url: '​/moonriver-analysis​/getScheduledExitQueue',
        method: 'get',
        params
    })
}
...
export function getMaxCollatorsPerRound(params) {
    return request({
        url: '/moonriver-analysis/getMaxCollatorsPerRound',
        method: 'get',
        params
    })
}
...
export function getNominatorReward(data) {
    return request({
        url: '/moonriver-analysis/getNominatorReward',
        method: 'post',
        data
    })
}
...
export function getCollatorReward(data) {
    return request({
        url: '/moonriver-analysis/getCollatorReward',
        method: 'post',
        data
    })
}
...
export function getCollatorTotalReward(data) {
    return request({
        url: '/moonriver-analysis/getCollatorTotalReward',
        method: 'post',
        data
    })
}
...
export function atStake(data) {
    return request({
        url: '/moonriver-analysis/atStake',
        method: 'post',
        data
    })
}
...
export function getCollatorActionHistory(data) {
    return request({
        url: '/moonriver-analysis/getCollatorActionHistory',
        method: 'post',
        data
    })
}
