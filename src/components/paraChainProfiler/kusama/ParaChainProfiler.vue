              ...
              <template slot-scope="scope">
                <el-tooltip :content="scope.row.description" placement="top">
                  <div class="row-crowdloanId">
                    ...
                    <div class="parachainName">
                      {{ scope.row.parachainName }}
                    </div>
                  </div>
                </el-tooltip>
              </template>
...
export default {
        ...
        for (
          ...
          if (round.ongoing === 0 || round.ongoing === false) {
            round.label =
              ...
              round.roundIndex +
              " ( Expiration Block:" +
              round.expirationBlocks.toString() +
              " )";
  ...
  methods: {
    ...
    formatedRaisedCap(row) {
      ...
      formatedCap = formatedCap / this.ksmRatio;
      formatedRaised = formatedRaised / this.ksmRatio;
      ...
      return formatedRaised + " / " + formatedCap + " KSM";
    },
    formatedCap(row) {
      let formatedCap = row.cap;
      let mRange = 1000000;
